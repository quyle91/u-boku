        ...
        <div class="dpro-opts-items">
            <div class="opt-wrapper" >
                ...
                <i class="fas fa-question-circle fa-sm"
                   ...
                   data-tooltip="<?php DUP_PRO_U::esc_attr_e('Checking this checkbox will enable filter all files. It emulate package creation without create a full package size'); ?>"></i>
            </div>
            <div class="opt-wrapper" >
                ...
                <i class="fas fa-question-circle fa-sm"
                   ...
                   data-tooltip="<?php DUP_PRO_U::esc_attr_e('Checking this checkbox will enable filter all db tables except wp_options'); ?>"></i>
            </div>
            <div class="opt-wrapper" >
                ...
                <i class="fas fa-question-circle fa-sm"
                   ...
                   data-tooltip="<?php DUP_PRO_U::esc_attr_e('Checking this checkbox will enable clean package test. if disabled pack created remain in pack list.'); ?>"></i>
            </div>
...
?>
    jQuery(document).ready(function ($)
    {
        ...
        DupPro.Tests.Init = function () {
            ...
            var fa_child = opt_toggle.find('.fa');

            opt_toggle.on('click', function() {
                var has_double_right_class = fa_child.hasClass('fa-angle-double-right');

                $("#dup_test_content .col_right").animate({
                    'flex-basis': has_double_right_class ? '0%' : '30%',
                    'max-width': has_double_right_class ? '0%' : '30%',
                    'opacity': has_double_right_class ? 0 : 1
                }, 500, function () {
                    fa_child.toggleClass('fa-angle-double-right').toggleClass('fa-angle-double-left');
                });
            });
