<?php
  ...
  require get_template_directory() . '/inc/register-widget-1.php';
  require get_template_directory() . '/inc/register-widget-2.php';
  require get_template_directory() . '/inc/register-widget-3.php';
?>
